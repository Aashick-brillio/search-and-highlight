...
let paragraph = `There are many variations of passages of Lorem Ipsum available, but the
...
const Search = (textVal) => {
  return processParagraph(textVal);
};
